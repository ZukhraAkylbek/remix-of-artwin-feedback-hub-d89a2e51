...
const translations = {
  ru: {
    ...
    object_HYT: 'ЖК «Хаят»',
    object_URP: 'ЖК «Урпак»',
    object_LND: 'ЖК «Лондон»',
    object_S_УЧ: 'Соцпроект: садик «Үмүт чырагы»',
  },
  ky: {
    ...
    reception: 'Reception',
    sales: 'Сатуу бөлүмү',
    hr: 'HR (кызматкерлер, эмгек шарттары)',
    marketing: 'Маркетинг',
    favorites_ssl: 'ССЛ (Кардарлар/Сүйүктүүлөр)',
    construction_tech: 'Курулуш (ТехБөлүм)',
    other: 'Коопсуздук жана экология (ОТиТБ)',
    ...
    // Residential objects
    object_TKY: 'ТЖК «Tokyo»',
    object_EST: 'ТЖК «Эсентай»',
    object_TKC: 'ТЖК «Токио Сити»',
    object_SEL: 'ИБ «Сеул»',
    object_HYT: 'ТЖК «Хаят»',
    object_URP: 'ТЖК «Урпак»',
    object_LND: 'ТЖК «Лондон»',
    object_S_УЧ: 'Соц долбоор: бала бакча «Үмүт чырагы»',
  },
  zh: {
    feedback: '反馈',
    ...
    // Residential objects
    object_TKY: '«Tokyo» 住宅区',
    object_EST: '«Эсентай» 住宅区',
    object_TKC: '«Токио Сити» 住宅区',
    object_SEL: '«Сеул» 商务中心',
    object_HYT: '«Хаят» 住宅区',
    object_URP: '«Урпак» 住宅区',
    object_LND: '«Лондон» 住宅区',
    object_S_УЧ: '社会项目: 幼儿园 «Үмүт чырагы»',
  },
  en: {
    feedback: 'Feedback',
    ...
    hr: 'HR (employees, working conditions)',
    marketing: 'Marketing',
    favorites_ssl: 'SSL (Clients/Favorites)',
    construction_tech: 'Construction (Tech Department)',
    other: 'Safety and Environment (OTiTB)',
    ...
    object_SEL: '«Seoul» Business Center',
    object_HYT: '«Hayat» Residence',
    object_URP: '«Urpak» Residence',
    object_LND: '«London» Residence',
    object_S_УЧ: 'Social project: kindergarten «Үмүт чырагы»',
  },
};
