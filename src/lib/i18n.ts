...
const translations = {
  ru: {
    ...
    object_HYT: 'ЖК "Хаят"',
    object_URP: 'ЖК "Урпак"',
    object_WLT: 'ЖК "Вилтон парк"',
    object_LND: 'ЖК "Лондон"',
    object_S_УЧ: 'Соц проект: садик "Үмүт чырагы"',
  },
  ky: {
  ...
  zh: {
    ...
    object_SEL: '"首尔"商务中心',
    object_HYT: '"海亚特"住宅区',
    object_URP: '"乌尔帕克公园"住宅区',
    object_WLT: '"威尔顿公园"住宅区',
    object_LND: '"伦敦广场"住宅区',
    object_S_УЧ: '社会项目"乌穆特·奇拉吉"幼儿园',
  },
  en: {
    feedback: 'Feedback',
    ...
    object_URP: '"Urpaq Park" residence',
    object_WLT: '"Wilton Park" residence',
    object_LND: '"London Square" residence',
    object_S_УЧ: 'Social project "Umut Chyragy" kindergarten',
  },
};
